...
// COMMENT: I used the light and dark mode javascript that we learnt in our previous exercise as a reference for this. I originally wanted to to use the dark/light mode idea as part of my web page however  noticed that it wouldn't work if the bedroom is an image. Therefore I coded so that the button can change between the two background images.
 let isnight= false;
 function change(){
     if(isnight=== false){
...
//  Comment: I was only able to do half of the image change for all the hidden buttons. Couldnt use the same method as the above code. I tried to use other alternatives however none of them worked.
 let isBear= false;
 function bear(){
     if(isBear=== false){
